...
*Dark* : ${user.dark}
*Cheat* : ${user.cheat}
*Total Box* : ${user.common + user.uncommon + user.rare + user.epic + user.mythic + user.legendary + user.secret + user.dark + user.cheat}
...
*Ular* : Lv. ${user.ular}
*Horse* : Lv. ${user.horse}
*Centaur* : Lv. ${user.centaur}
*Rhinoceros* : Lv. ${user.rhinoceros}
*Lion* : Lv. ${user.lion}
*Beruang* : Lv. ${user.beruang}
*Griffin* : Lv. ${user.griffin}
*Phonix* : Lv. ${user.phonix}
*Kyubi* : Lv. ${user.kyubi}
*Naga* : Lv. ${user.naga}
*Godzilla* : Lv. ${user.godzilla}
`
