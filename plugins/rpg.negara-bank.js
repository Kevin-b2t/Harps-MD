                ...
                case 'info-bumn': {
                    ...
                    if (negara.pln) {
                        ...
                        txt += `┣ ⚡ *Perusahaan Listrik Negara (PLN)*\n`
                            ...
                            + `┃   ◦ Tenaga Kerja: ${p.karyawan.toLocaleString('id-ID')} / 1jt Orang\n`
                            + `┃   ◦ Total Kapital Investor: ${formatRp(p.totalInvestasi)}\n┃\n`;
                    } else txt += `┣ ⚡ *PLN Negara:* 🔴 Mati Total / Belum Ada Infrastruktur\n┃\n`;
                    ...
                    if (negara.pdam) {
                        ...
                        txt += `┣ 💧 *Perusahaan Daerah Air Minum (PDAM)*\n`
                            ...
                            + `┃   ◦ Tenaga Kerja: ${p.karyawan.toLocaleString('id-ID')} / 1jt Orang\n`
                            + `┃   ◦ Total Kapital Investor: ${formatRp(p.totalInvestasi)}\n┃\n`;
                    } else txt += `┣ 💧 *PDAM Negara:* 🔴 Belum Beroperasi\n┃\n`;

                    txt += `┣ 💼 *Holding Portofolio Sitaan Pajak*\n`
                        + `┃   ◦ Total Entitas Disita: ${negara.bumn.length} PT\n`
                        + `┃   ◦ Akumulasi Likuiditas Sitaan: *${formatRp(negara.bumn.reduce((sum, pt) => sum + (pt.saldo || 0), 0))}*\n`
                        + `┃\n╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╯`;
                    return m.reply(txt);
                }
