let handler  = async (m, { conn, command, args, usedPrefix, owner }) => {
    ...
    let dataAirmineral = getMarketPrice('airmineral', 5000, 1000, 100000); let Bairmineral = dataAirmineral.beli; let SAirmineral = dataAirmineral.jual; let statusAirmineral = dataAirmineral.status;
...
`.trim()
    ...
    const shopItems = {
        ...
        'airmineral': { costType: 'money', B: Bairmineral, S: Sairmineral, data: dataAirmineral, db: 'airmineral', name: 'Airmineral' },
